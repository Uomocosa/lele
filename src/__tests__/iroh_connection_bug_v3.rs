...
#[tokio::test]
// run test by using: 'cargo test __tests__::iroh_connection_bug_v3::test_iroh_connection_bug_v3 -- --exact --nocapture'
async fn test_iroh_connection_bug_v3() -> Result<()> {
    iroh_connection_bug_v3().await
}

#[tokio::test]
// run test by using: 'cargo test __tests__::iroh_connection_bug_v3_v3::print_ips -- --exact --nocapture'
...
pub async fn iroh_connection_bug_v3() -> Result<()> {
